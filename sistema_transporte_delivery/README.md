...
```
[Viaje en Curso] ──► Captura GPS en tiempo real (Coordenadas exactas)
       │
[Viaje Finalizado] ──► Apagar captura GPS del cliente
       │
[Archivo Histórico (30 días)] ──► Ofuscar coordenadas exactas a nivel de Comuna/Sector
```
