...
function highlightSyntax(code) {
  ...
  const keywords = [
    ...
    "const ", "let ", "function ", "async ", "await ", "const ", "export ", "import ", "from ",
    "\\$pdo", "prepare", "execute", "select ", "insert ", "delete ", "update ", "where ", "values ",
    "package ", "import ", "type ", "struct ", "func ", "nil", "defer ", "return ", "go ", "var "
  ];
  ...
  // Highlight strings (simple match)
  escaped = escaped.replace(/(['"`])(.*?)\1/g, '<span class="string">$1$2$1</span>');
